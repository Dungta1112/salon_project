...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ("id", "username", "email", "phone", "full_name", "role", "account_status", "is_active", "customer_profile_id")
        read_only_fields = ("role", "account_status", "is_active", "customer_profile_id")
